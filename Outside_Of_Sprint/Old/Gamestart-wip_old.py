	        ...
	        while True:
	            for msg in inport:
	                for msg in inport.iter_pending():
	                    ...
	                    elif game_start == 'True' and game_start == 'True' and ((North_pressed,East_pressed,West_pressed,South_pressed) != 'True') and (directional_var ==(NorthVal, SouthVal, EastVal, WestVal)):
