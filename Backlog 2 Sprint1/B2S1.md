...
8. Still in Reaper Preferences under Audio, go to MIDI Devices

9. Select the loopMIDI Port in the MIDI Output List

10. If not enabled, right-click on it and select "Enable Output"
